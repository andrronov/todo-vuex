...
<template>
  <div class="w-full h-screen flex items-center justify-center bg-indigo-800 text-xl relative overflow-hidden">
    ...
    <!-- Контент -->
    <div class="max-w-7xl relative w-full max-h-4/5 p-4 mx-2 rounded-xl backdrop-blur-xl border-2 border-white/50 bg-white/15 flex flex-col items-center justify-center gap-8">
